...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/Input/VloxyEngine.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Quit"",
                    ""type"": ""Button"",
                    ""id"": ""d835121d-de09-4bb9-8984-d51ee8b4b0ad"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""fe6adac3-b360-4a82-8d08-619d666c8ae6"",
                ...
                {
                    ""name"": """",
                    ""id"": ""fac57465-10dc-4643-9867-21aaff3a0a4c"",
                    ""path"": ""<Gamepad>/start"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""f223994a-362d-497d-be45-5e1b511bd4b8"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1ad140cc-37b7-4a92-b690-48da1e572929"",
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            // RuntimeTools
            m_RuntimeTools = asset.FindActionMap("RuntimeTools", throwIfNotFound: true);
            m_RuntimeTools_Stats = m_RuntimeTools.FindAction("Stats", throwIfNotFound: true);
            m_RuntimeTools_Console = m_RuntimeTools.FindAction("Console", throwIfNotFound: true);
        }

        ~@VloxyInput()
        {
            UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, VloxyInput.Player.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, VloxyInput.UI.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_RuntimeTools.enabled, "This will cause a leak and performance issues, VloxyInput.RuntimeTools.Disable() has not been called.");
        }
        ...
        public struct PlayerActions
        {
            ...
            /// <summary>
            /// Provides access to the underlying input action "Player/Altitude".
            /// </summary>
        ...
        // RuntimeTools
        private readonly InputActionMap m_RuntimeTools;
        private List<IRuntimeToolsActions> m_RuntimeToolsActionsCallbackInterfaces = new List<IRuntimeToolsActions>();
        private readonly InputAction m_RuntimeTools_Stats;
        private readonly InputAction m_RuntimeTools_Console;
        /// <summary>
        /// Provides access to input actions defined in input action map "RuntimeTools".
        /// </summary>
        public struct RuntimeToolsActions
        {
            private @VloxyInput m_Wrapper;
            ...
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public RuntimeToolsActions(@VloxyInput wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            /// Provides access to the underlying input action "RuntimeTools/Stats".
            /// </summary>
            public InputAction @Stats => m_Wrapper.m_RuntimeTools_Stats;
            /// <summary>
            /// Provides access to the underlying input action "RuntimeTools/Console".
            /// </summary>
            public InputAction @Console => m_Wrapper.m_RuntimeTools_Console;
            /// <summary>
            /// Provides access to the underlying input action map instance.
            /// </summary>
            public InputActionMap Get() { return m_Wrapper.m_RuntimeTools; }
            /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
            public void Enable() { Get().Enable(); }
            /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
            public void Disable() { Get().Disable(); }
            ...
            public bool enabled => Get().enabled;
            /// <summary>
            /// Implicitly converts an <see ref="RuntimeToolsActions" /> to an <see ref="InputActionMap" /> instance.
            /// </summary>
            public static implicit operator InputActionMap(RuntimeToolsActions set) { return set.Get(); }
            /// <summary>
            /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
            /// </summary>
            /// <param name="instance">Callback instance.</param>
            ...
            /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
            /// </remarks>
            /// <seealso cref="RuntimeToolsActions" />
            public void AddCallbacks(IRuntimeToolsActions instance)
            {
                if (instance == null || m_Wrapper.m_RuntimeToolsActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_RuntimeToolsActionsCallbackInterfaces.Add(instance);
            ...
            /// </remarks>
            /// <seealso cref="RuntimeToolsActions" />
            private void UnregisterCallbacks(IRuntimeToolsActions instance)
            {
                @Stats.started -= instance.OnStats;
                @Stats.performed -= instance.OnStats;
                @Stats.canceled -= instance.OnStats;
            ...
            /// <summary>
            /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="RuntimeToolsActions.UnregisterCallbacks(IRuntimeToolsActions)" />.
            /// </summary>
            /// <seealso cref="RuntimeToolsActions.UnregisterCallbacks(IRuntimeToolsActions)" />
            public void RemoveCallbacks(IRuntimeToolsActions instance)
            {
                if (m_Wrapper.m_RuntimeToolsActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }
            ...
            /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
            /// </remarks>
            /// <seealso cref="RuntimeToolsActions.AddCallbacks(IRuntimeToolsActions)" />
            /// <seealso cref="RuntimeToolsActions.RemoveCallbacks(IRuntimeToolsActions)" />
            /// <seealso cref="RuntimeToolsActions.UnregisterCallbacks(IRuntimeToolsActions)" />
            public void SetCallbacks(IRuntimeToolsActions instance)
            {
                foreach (var item in m_Wrapper.m_RuntimeToolsActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_RuntimeToolsActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
        /// <summary>
        /// Provides a new <see cref="RuntimeToolsActions" /> instance referencing this action map.
        /// </summary>
        public RuntimeToolsActions @RuntimeTools => new RuntimeToolsActions(this);
        ...
        public interface IPlayerActions
        {
            ...
            /// <summary>
            /// Method invoked when associated input action "Altitude" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
            /// </summary>
            /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
            /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
            /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        ...
        /// <summary>
        /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "RuntimeTools" which allows adding and removing callbacks.
        /// </summary>
        /// <seealso cref="RuntimeToolsActions.AddCallbacks(IRuntimeToolsActions)" />
        /// <seealso cref="RuntimeToolsActions.RemoveCallbacks(IRuntimeToolsActions)" />
        public interface IRuntimeToolsActions
        {
            /// <summary>
